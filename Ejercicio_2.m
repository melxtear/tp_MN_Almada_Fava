...
n = length(X);
x_computacional = X(n); % guardamos en una variable el valor de la última posición X en el vector de posiciones calculado con
% el metodo para resolver Ec. Dif. de RKO4
disp('Ultima posicion de la masa m2 calculada con Runge Kutta: ');
