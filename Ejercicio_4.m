...
disp('Valores de la velocidad de la masa m2 en funcion de t: ')
Velocidades %imprimimos para ver los valores de velocidades en pantalla

% Graficamos la velocidad V en función del tiempo t
H4 = figure(4);
...
% Realizamos un gráfico en el que se pueda ver la velocidad y la posición en función del tiempo
H5 = figure(5);
